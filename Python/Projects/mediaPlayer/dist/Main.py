...
class YouTubeDownloader(ShowBase):
    ...
    def doLinkInput(self, text):
        ...
        if "youtube.com" in text and "https://" in text:
            ...
            print("Link copied from clipboard: " + Color.CYAN + self.link + Color.RESET)
            try:
                obj = YouTube(self.link)
                print(f"Title: {Color.CYAN}{obj.title}{Color.RESET}")
            except:
                ...
        else:
